...
export default function Cart() {
  ...
  const handleCheckout = () => {
    ...
    // Example future backend integration:
    // await api.post('/checkout', cartItems)
  }
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-card border-2 border-border rounded-xl p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between"
              >
